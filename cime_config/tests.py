...
_TESTS = {
    ...
    "fates" : {
        "tests" : (
            ...
            "ERS_D_Lm13.f45_f45.IELMFATES.elm-fates_cold_nocomp",
            "SMS_D_Ld5.f45_f45.IELMFATES.elm-fates_cold",
            "ERP_Ld9.f45_f45.IELMFATES.elm-fates_cold_allvars",
            "SMS_Lm6.f45_f45.IELMFATES.elm-fates",
            "ERS_Ld60.f45_f45.IELMFATES.elm-fates_cold_logging",
            "ERS_Ld30.f45_f45.IELMFATES.elm-fates_cold_sizeagemort",
            "ERS_Ld30.f45_f45.IELMFATES.elm-fates_satphen",
            "ERS_Ld30.f45_f45.IELMFATES.elm-fates_cold_fixedbiogeo",
            "ERS_Ld60.f45_f45.IELMFATES.elm-fates_cold_nofire",
            "ERS_Ld60.f45_f45.IELMFATES.elm-fates_cold_st3",
            "ERS_Ld60.f45_f45.IELMFATES.elm-fates_cold_pphys",
            "ERS_Ld30.f45_f45.IELMFATES.elm-fates_cold_nocomp",
            "ERS_Ld30.f45_f45.IELMFATES.elm-fates_cold_nocomp_fixedbiogeo",
            "ERS_D_Ld30.f45_f45.IELMFATES.elm-fates_cold_prt2",
            "ERS_Ld60.f45_f45.IELMFATES.elm-fates",
            )
        },
