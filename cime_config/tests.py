...
_TESTS = {
    ...
    "fates" : {
        "tests" : (
            ...
            "SMS.f45_f45.IELMFATES-fates_satphen",
            "ERS_D_Ld15.f45_f45.IELMFATES-fates_cold_treedamage",
            "ERS_D_Ld5.f45_f45.IELMFATES-fates_cold",
            "ERS_D_Lm13.f45_f45.IELMFATES-fates_cold_nocomp",
            "SMS_D_Ld5.f45_f45.IELMFATES-fates_cold",
            "ERP_Ld9.f45_f45.IELMFATES-fates_cold_allvars",
            "SMS_Lm6.f45_f45.IELMFATES-fates",
            "ERS_Ld60.f45_f45.IELMFATES-fates_cold_logging",
            "ERS_Ld30.f45_f45.IELMFATES-fates_cold_sizeagemort",
            "ERS_Ld30.f45_f45.IELMFATES-fates_satphen",
            "ERS_Ld30.f45_f45.IELMFATES-fates_cold_fixedbiogeo",
            "ERS_Ld60.f45_f45.IELMFATES-fates_cold_nofire",
            "ERS_Ld60.f45_f45.IELMFATES-fates_cold_st3",
            "ERS_Ld60.f45_f45.IELMFATES-fates_cold_pphys",
            "ERS_Ld30.f45_f45.IELMFATES-fates_cold_nocomp",
            "ERS_Ld30.f45_f45.IELMFATES-fates_cold_nocomp_fixedbiogeo",
            "ERS_D_Ld30.f45_f45.IELMFATES-fates_cold_prt2",
            "ERS_Ld60.f45_f45.IELMFATES-fates",
            )
        },
