  ...
  if (COMP_NAME STREQUAL "cpl")
    ...
    if (COMP_NAME STREQUAL "csm_share")
      ...
      if (COMP_NAME STREQUAL "elm")
        ...
        target_link_directories(${TARGET_NAME} PRIVATE /global/homes/r/rgknox/local/FTorch/bld-gnu13.2.1)
        target_link_libraries(${TARGET_NAME} PRIVATE /global/homes/r/rgknox/local/FTorch/bld-gnu13.2.1/libftorch.so)
        target_link_options(${TARGET_NAME} PRIVATE -Wl,-rpath,/global/homes/r/rgknox/local/FTorch/bld-gnu13.2.1)
        target_link_directories(${TARGET_NAME} PRIVATE /global/homes/r/rgknox/local/libtorch/lib)
        target_link_options(${TARGET_NAME} PRIVATE -Wl,-rpath,/global/homes/r/rgknox/local/libtorch/lib)
      endif()
      if (COMP_NAME STREQUAL "ww3")
